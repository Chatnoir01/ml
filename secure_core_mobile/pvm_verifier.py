...
class PvmAttestationVerifier:
    ...
    def verify(self, *, statement: PvmAttestationStatement, challenge: bytes,
        ...
        # Leaf possession is necessary but insufficient. Android/AVF chain
        # validation and trust-anchor policy remain intentionally fail-closed.
        return PvmVerificationResult(True, True, True, False, "platform-chain-verification-not-implemented")
