"""Phase 2D terminal-freeze gate using fitness receipts only.

This module is intentionally held-out blind. It verifies the 36 arm cells and
freezes terminal identity before any Block-W validation module or seed constant
is imported.
"""
