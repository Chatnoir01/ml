...
# Phase 1M DU-hotspot-directed bridge experiment. Declared publicly in issues
# before branch implementation or any scientific Phase-1M run.
PHASE1M_DEV_SEEDS = (2111, 2113, 2129, 2131, 2137)
PHASE1M_CONFIRM_RESERVED_SEEDS = (2203, 2207, 2213, 2221, 2237, 2239, 2243, 2251, 2267)

# Phase 1N joint DDT + Walsh proposal experiment. Declared publicly in issues
# #43-#47 before branch implementation or any scientific Phase-1N run.
PHASE1N_DEV_SEEDS = (2309, 2311, 2333, 2339, 2341)
PHASE1N_CONFIRM_RESERVED_SEEDS = (2401, 2411, 2417, 2423, 2437, 2441, 2447, 2459, 2467)

# Phase 1O multi-hotspot Walsh plateau repair. Declared publicly in issues
# #49-#53 before branch implementation or any scientific Phase-1O run.
PHASE1O_DEV_SEEDS = (2503, 2521, 2531, 2539, 2543)
PHASE1O_CONFIRM_RESERVED_SEEDS = (2609, 2617, 2621, 2633, 2647, 2657, 2663, 2671, 2683)
...
def validate_seed_registry() -> None:
    ...
    blocks = [
        ...
        ("PHASE1N_DEV_SEEDS", _as_set(PHASE1N_DEV_SEEDS)),
        ("PHASE1N_CONFIRM_RESERVED_SEEDS", _as_set(PHASE1N_CONFIRM_RESERVED_SEEDS)),
        ("PHASE1O_DEV_SEEDS", _as_set(PHASE1O_DEV_SEEDS)),
        ("PHASE1O_CONFIRM_RESERVED_SEEDS", _as_set(PHASE1O_CONFIRM_RESERVED_SEEDS)),
    ]
